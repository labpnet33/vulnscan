...
APP_URL    = _mail_os.environ.get("VULNSCAN_APP_URL",  "http://localhost:5000")
...
SMTP_USER  = _mail_os.environ.get("VULNSCAN_SMTP_USER", "")
SMTP_PASS  = _mail_os.environ.get("VULNSCAN_SMTP_PASS", "")
