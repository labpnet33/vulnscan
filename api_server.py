...
function renderLynis(d){
  ...
  var profileUsed=d.profile_used||'system';
  var complianceUsed=d.compliance_used||'none';
  var categoryUsed=d.category_used||'all';
  ...
  html+='<div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px"><span class="tag">Profile: '+profileUsed+'</span><span class="tag">Compliance: '+complianceUsed+'</span><span class="tag">Category: '+categoryUsed+'</span></div>';
  html+='<div class="card card-p" style="margin-bottom:10px"><div class="card-title" style="margin-bottom:6px">Security Posture Summary</div><div style="font-size:12px;line-height:1.6">Overall posture: <strong style="color:'+sc_col+'">'+grade+'</strong>. '+(w.length?('Address '+Math.min(w.length,10)+' high-priority warning(s) first. '):'No warnings detected. ')+'Use the suggestions list as a hardening checklist.'+(d.exit_code!==undefined?(' <span style="color:var(--text3)">Lynis exit code: '+d.exit_code+'</span>'):'')+'</div></div>';
