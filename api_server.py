    ...
    <div class="content">
      ...
      <div class="page" id="page-shellphish">
        ...
        <div class="card card-p" style="margin-bottom:14px">
          ...
          <div class="fg"><label>ARGUMENTS</label><input class="inp inp-mono" id="sp-args" type="text" placeholder="-u https://example.com -w /usr/share/wordlists/dirb/common.txt"/></div>
...
/* ffuf */
async function runGenericTool('ffuf','ffuf') {
...
/* nuclei */
async function runGenericTool('nuclei','nuclei') {
...
/* whatweb */
async function runGenericTool('whatweb','whatweb') {
...
/* wapiti */
async function runGenericTool('wapiti','wapiti') {
